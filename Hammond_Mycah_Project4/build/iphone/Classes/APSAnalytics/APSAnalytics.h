 ...
 * to send analytic data that can be viewed on the Hammond_Mycah_Project4 Dashboard.
 *
 * For information on getting started with Hammond_Mycah_Project4 Platform Services,
