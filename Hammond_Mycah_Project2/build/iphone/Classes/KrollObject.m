...
//@interface Hammond_Mycah_Project2Object : NSObject
//@end

@interface Hammond_Mycah_Project2Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hammond_Mycah_Project2Object class]])
		{
			for (NSString *key in [[(Hammond_Mycah_Project2Object*)o modules] allKeys])
			{
