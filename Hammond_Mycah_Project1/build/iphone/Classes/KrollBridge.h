...
@interface Hammond_Mycah_Project1Object : KrollCoverageObject {
#else
@interface Hammond_Mycah_Project1Object : KrollObject {
#endif
@private
...
extern NSString * Hammond_Mycah_Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hammond_Mycah_Project1Object *_hammond_mycah_project1;
    KrollObject* console;
	BOOL shutdown;
