...
// in simulator we redefine to format for Hammond_Mycah_Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.hammond_mycah_project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hammond_mycah_project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHammond_Mycah_Project1NativeItemNone = -1, 
	UIHammond_Mycah_Project1NativeItemSpinner = -2,
	UIHammond_Mycah_Project1NativeItemProgressBar = -3,
	
	UIHammond_Mycah_Project1NativeItemSlider = -4,
	UIHammond_Mycah_Project1NativeItemSwitch = -5,
	UIHammond_Mycah_Project1NativeItemMultiButton = -6,
	UIHammond_Mycah_Project1NativeItemSegmented = -7,
	
	UIHammond_Mycah_Project1NativeItemTextView = -8,
	UIHammond_Mycah_Project1NativeItemTextField = -9,
	UIHammond_Mycah_Project1NativeItemSearchBar = -10,
	
	UIHammond_Mycah_Project1NativeItemPicker = -11,
	UIHammond_Mycah_Project1NativeItemDatePicker = -12,
	
	UIHammond_Mycah_Project1NativeItemInfoLight = -13,
	UIHammond_Mycah_Project1NativeItemInfoDark = -14,
	
	UIHammond_Mycah_Project1NativeItemDisclosure = -15,
	
	UIHammond_Mycah_Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hammond_Mycah_Project1 instances of
