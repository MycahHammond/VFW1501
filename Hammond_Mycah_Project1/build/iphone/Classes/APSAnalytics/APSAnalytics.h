 ...
 * to send analytic data that can be viewed on the Hammond_Mycah_Project1 Dashboard.
 *
 * For information on getting started with Hammond_Mycah_Project1 Platform Services,
