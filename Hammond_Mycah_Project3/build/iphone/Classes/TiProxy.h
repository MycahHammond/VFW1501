...
//Rare exceptions to indicate a bug in the _hammond_mycah_project code (Eg, function that a subclass should have implemented)
...
/**
 The base class for Hammond_Mycah_Project proxies.
 */
