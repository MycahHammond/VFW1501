...
// in simulator we redefine to format for Hammond_Mycah_Project Developer console
...
{\
	NSString * exceptionName = [@"org.hammond_mycah_project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hammond_mycah_project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHammond_Mycah_ProjectNativeItemNone = -1, 
	UIHammond_Mycah_ProjectNativeItemSpinner = -2,
	UIHammond_Mycah_ProjectNativeItemProgressBar = -3,
	
	UIHammond_Mycah_ProjectNativeItemSlider = -4,
	UIHammond_Mycah_ProjectNativeItemSwitch = -5,
	UIHammond_Mycah_ProjectNativeItemMultiButton = -6,
	UIHammond_Mycah_ProjectNativeItemSegmented = -7,
	
	UIHammond_Mycah_ProjectNativeItemTextView = -8,
	UIHammond_Mycah_ProjectNativeItemTextField = -9,
	UIHammond_Mycah_ProjectNativeItemSearchBar = -10,
	
	UIHammond_Mycah_ProjectNativeItemPicker = -11,
	UIHammond_Mycah_ProjectNativeItemDatePicker = -12,
	
	UIHammond_Mycah_ProjectNativeItemInfoLight = -13,
	UIHammond_Mycah_ProjectNativeItemInfoDark = -14,
	
	UIHammond_Mycah_ProjectNativeItemDisclosure = -15,
	
	UIHammond_Mycah_ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hammond_Mycah_Project instances of
