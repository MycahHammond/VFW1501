...
// in simulator we redefine to format for Hammond_Mycah_Project2 Developer console
...
{\
	NSString * exceptionName = [@"org.hammond_mycah_project2." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hammond_mycah_project2";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHammond_Mycah_Project2NativeItemNone = -1, 
	UIHammond_Mycah_Project2NativeItemSpinner = -2,
	UIHammond_Mycah_Project2NativeItemProgressBar = -3,
	
	UIHammond_Mycah_Project2NativeItemSlider = -4,
	UIHammond_Mycah_Project2NativeItemSwitch = -5,
	UIHammond_Mycah_Project2NativeItemMultiButton = -6,
	UIHammond_Mycah_Project2NativeItemSegmented = -7,
	
	UIHammond_Mycah_Project2NativeItemTextView = -8,
	UIHammond_Mycah_Project2NativeItemTextField = -9,
	UIHammond_Mycah_Project2NativeItemSearchBar = -10,
	
	UIHammond_Mycah_Project2NativeItemPicker = -11,
	UIHammond_Mycah_Project2NativeItemDatePicker = -12,
	
	UIHammond_Mycah_Project2NativeItemInfoLight = -13,
	UIHammond_Mycah_Project2NativeItemInfoDark = -14,
	
	UIHammond_Mycah_Project2NativeItemDisclosure = -15,
	
	UIHammond_Mycah_Project2NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hammond_Mycah_Project2 instances of
