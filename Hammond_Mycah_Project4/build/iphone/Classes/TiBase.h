...
// in simulator we redefine to format for Hammond_Mycah_Project4 Developer console
...
{\
	NSString * exceptionName = [@"org.hammond_mycah_project4." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.hammond_mycah_project4";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIHammond_Mycah_Project4NativeItemNone = -1, 
	UIHammond_Mycah_Project4NativeItemSpinner = -2,
	UIHammond_Mycah_Project4NativeItemProgressBar = -3,
	
	UIHammond_Mycah_Project4NativeItemSlider = -4,
	UIHammond_Mycah_Project4NativeItemSwitch = -5,
	UIHammond_Mycah_Project4NativeItemMultiButton = -6,
	UIHammond_Mycah_Project4NativeItemSegmented = -7,
	
	UIHammond_Mycah_Project4NativeItemTextView = -8,
	UIHammond_Mycah_Project4NativeItemTextField = -9,
	UIHammond_Mycah_Project4NativeItemSearchBar = -10,
	
	UIHammond_Mycah_Project4NativeItemPicker = -11,
	UIHammond_Mycah_Project4NativeItemDatePicker = -12,
	
	UIHammond_Mycah_Project4NativeItemInfoLight = -13,
	UIHammond_Mycah_Project4NativeItemInfoDark = -14,
	
	UIHammond_Mycah_Project4NativeItemDisclosure = -15,
	
	UIHammond_Mycah_Project4NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Hammond_Mycah_Project4 instances of
