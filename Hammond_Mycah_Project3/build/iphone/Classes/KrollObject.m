...
//@interface Hammond_Mycah_ProjectObject : NSObject
//@end

@interface Hammond_Mycah_ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hammond_Mycah_ProjectObject class]])
		{
			for (NSString *key in [[(Hammond_Mycah_ProjectObject*)o modules] allKeys])
			{
