...
@interface Hammond_Mycah_Project4Object : KrollCoverageObject {
#else
@interface Hammond_Mycah_Project4Object : KrollObject {
#endif
@private
...
extern NSString * Hammond_Mycah_Project4$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hammond_Mycah_Project4Object *_hammond_mycah_project4;
    KrollObject* console;
	BOOL shutdown;
