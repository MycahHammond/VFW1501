 ...
 * to send analytic data that can be viewed on the Hammond_Mycah_Project Dashboard.
 *
 * For information on getting started with Hammond_Mycah_Project Platform Services,
