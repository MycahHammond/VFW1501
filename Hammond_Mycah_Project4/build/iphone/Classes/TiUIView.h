...
/**
 Base class for all Hammond_Mycah_Project4 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Hammond_Mycah_Project4 view hierarchy (such as wrapped iOS UIViews) was touched.
