...
@interface Hammond_Mycah_ProjectObject : KrollCoverageObject {
#else
@interface Hammond_Mycah_ProjectObject : KrollObject {
#endif
@private
...
extern NSString * Hammond_Mycah_Project$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hammond_Mycah_ProjectObject *_hammond_mycah_project;
    KrollObject* console;
	BOOL shutdown;
