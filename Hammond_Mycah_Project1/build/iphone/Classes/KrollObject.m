...
//@interface Hammond_Mycah_Project1Object : NSObject
//@end

@interface Hammond_Mycah_Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Hammond_Mycah_Project1Object class]])
		{
			for (NSString *key in [[(Hammond_Mycah_Project1Object*)o modules] allKeys])
			{
