...
@interface Hammond_Mycah_Project2Object : KrollCoverageObject {
#else
@interface Hammond_Mycah_Project2Object : KrollObject {
#endif
@private
...
extern NSString * Hammond_Mycah_Project2$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	Hammond_Mycah_Project2Object *_hammond_mycah_project2;
    KrollObject* console;
	BOOL shutdown;
