...
/**
 The base class for all Hammond_Mycah_Project2 modules
 */
...
/**
 Hammond_Mycah_Project2 Platform calls this method on startup.
 */
-(void)startup;

/**
 Hammond_Mycah_Project2 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 Hammond_Mycah_Project2 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 Hammond_Mycah_Project2 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 Hammond_Mycah_Project2 Platform calls this method on resume.
 @param sender The sender of the event.
 */
