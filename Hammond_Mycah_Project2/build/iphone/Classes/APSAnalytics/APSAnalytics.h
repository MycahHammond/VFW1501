 ...
 * to send analytic data that can be viewed on the Hammond_Mycah_Project2 Dashboard.
 *
 * For information on getting started with Hammond_Mycah_Project2 Platform Services,
